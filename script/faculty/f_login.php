...
$sql_check = "SELECT * FROM faculty_master WHERE f_id='$f_id'";
$result_check = mysqli_query($con, $sql_check);
if (mysqli_num_rows($result_check) == 0) {
    header("Location: f_login.php?error=not_exist");
    exit();
}
...
<div class="main">
    <div class="login">
      ...
      <div class="textbox"><input type="number" placeholder="FACULTY ID" name="f_id" required></div>
